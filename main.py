...
def run():
    ...
    Nw1, Nw2 = Piece('N','W','♘',2,9), Piece('N','W','♘',2,10)
    Rw1, Rw2 = Piece('R','W','♖',4,11), Piece('R','W','♖',4,12)
    Bw1, Bw2 = Piece('B','W','♗',3,13), Piece('B','W','♗',3,14)     
    Qw, Kw =  Piece('Q','W','♕',6,15),Piece('K','W','♔',8,16)
    ...
    Nb1, Nb2 = Piece('N','B','♞',2,25), Piece('N','B','♞',2,26)
    Rb1, Rb2 = Piece('R','B','♜',4,27), Piece('R','B','♜',4,28)
    Bb1, Bb2 = Piece('B','B','♝',3,29), Piece('B','B','♝',3,30)   
    Qb, Kb =  Piece('Q','B','♛',6,31),Piece('K','B','♚',8,32)
